...
class Listing {
    ...
    public static void main(String[] args){
        ...
        // ArrayList<int> favoriteNumbers = new ArrayList<int>();              // Why is this not working?
        ...
        // EXERCISE: Find out ways to insert items at specific indices, get items, and other array operations
